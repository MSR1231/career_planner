...
import CareerFlowchart from './components/CareerFlowchart';  // Corrected import
  ...
  return (
    <Router>
        ...
        <div className="container">
          ...
          <div className="collapse navbar-collapse" id="navMenu">
            <ul className="navbar-nav ms-auto gap-3">
              ...
              <li className="nav-item"><Link to="/career-flowchart" className="nav-link">Career Flowcharts</Link></li>
              {user ? (
                <>
                  <li className="nav-item"><Link to="/dashboard" className="nav-link">Dashboard</Link></li>
                  <li className="nav-item"><button className="btn btn-warning btn-sm" onClick={logout}>Logout</button></li>
                </>
              ) : (
                <>
      ...
      <Routes>
        ...
        <Route path="/career-flowchart" element={<CareerFlowchart />} /> {/* Correct route */}
        <Route path="/quiz" element={<Quiz setUserInterests={setUserInterests} setUserLocation={setUserLocation} />} />
        <Route path="/colleges" element={<CollegeList colleges={colleges} userInterests={userInterests} userLocation={userLocation} />} />
        ...
        <Route path="/career-paths" element={<CareerFlowchart />} /> {/* Optional: can also reuse flowchart */}
        ...
        <Route path="/signup" element={!user ? <Signup onSignup={setUser} /> : <Navigate to="/dashboard" replace />} />
        <Route path="/dashboard" element={user ? <Dashboard user={user} userInterests={userInterests} userLocation={userLocation} /> : <Navigate to="/login" replace />} />
